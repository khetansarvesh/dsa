...
This is an optimized way to solve questions where you have sorted matrix. These questions can be solved via brute force approach (two pointers) in O(n^2) approach but since matrix is sorted we can use this information to reduce the time complexity.
- Questions where 'sorted' word mentioned :
