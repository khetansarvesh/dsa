...
Now in all the above problem we broke a bigger problem into a smaller problem (top-down approach) and solved it using recurssion. But there is this special 'rare' problem (Tower Of Hanoi) wherein we go from a smaller problem to a larger problem (bottom - up approach).
